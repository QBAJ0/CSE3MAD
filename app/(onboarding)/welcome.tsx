  ...
  return (
    ...
    >
      ...
      <View style={styles.card}>
        ...
        {/* Join Team button — primary outlined */}
        <Pressable
          style={({ pressed }) => [
            styles.secondaryBtn,
            pressed && styles.pressed,
...
function createStyles(c: ColorTokens) {
  return StyleSheet.create({
    ...
    // Hero (top branded section — teal kept hardcoded as brand splash)
    hero: {
      flex: 1,
      backgroundColor: "#0F766E",
      alignItems: "center",
